...
class Parser:
    ...
    def remove_special_characters(self, no_accent_data):
        """
    ...
    def get_cleaned_data_list(self, no_special_characters_data):
        """
            Cutting the string into words
            :param: no_special_characters_data is a string
            :return: a list containing all the words of the given string
            :rtype: list
        """
        # We transform the string into a list of words
        cleaned_data_list = []
        cleaned_data_list = no_special_characters_data.split(' ')
